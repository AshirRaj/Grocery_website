...
const App = () => {
  const isSellerPath = useLocation().pathname.includes("seller") || useLocation().pathname.includes("admin");
    ...
    <div className="text-default min-h-screen">
      ...
      >
        <Routes>
          ...
          <Route
            path="/admin"
            element={isAdmin ? <AdminLayout /> : <SellerLogin />}
          >
            <Route index element={isAdmin ? <AdminDashboard /> : null} />
            <Route path="orders" element={isAdmin ? <AdminOrders /> : null} />
            <Route path="approval" element={isAdmin ? <AdminProductApproval /> : null} />
          </Route>
        </Routes>
      </div>
